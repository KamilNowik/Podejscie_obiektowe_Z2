#include <iostream>
#include "pytanie.h" // cudzys³ów oznacza szukania biblioteki w projekcie.
...
void Pytanie::wczytaj() // robimy tak, aby by³o wiadomo o które "wczytaj" chodzi, dotycz¹ce której klasy.
{
   fstream plik;
